...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Motor_AIN1_Pin|Relay_Right_Pin|Motor_BIN1_Pin|Relay_White_Pin
                          |Relay_Yellow_Pin|Relay_Left_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = Motor_AIN1_Pin|Relay_Right_Pin|Motor_BIN1_Pin|Relay_White_Pin
                          |Relay_Yellow_Pin|Relay_Left_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
